...
generate-e2e-templates-main: $(KUSTOMIZE)
	...
	$(KUSTOMIZE) build $(DOCKER_TEMPLATES)/main/cluster-template-remotehcp --load-restrictor LoadRestrictionsNone > $(DOCKER_TEMPLATES)/main/cluster-template-remotehcp.yaml
